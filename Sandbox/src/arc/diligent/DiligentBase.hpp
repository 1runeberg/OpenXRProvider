...
#include "DiligentInputController.hpp"
...
inline void DiligentBase::Update(double CurrTime, double ElapsedTime)
{
    ++m_NumFramesRendered;
...
inline void DiligentBase::Initialize(const SampleInitInfo& InitInfo)
{
...
extern DiligentBase* CreateSample();
