...
void Sandbox::Initialize(const SampleInitInfo& InitInfo)
{
    DiligentBase::Initialize(InitInfo);
...
{
    DiligentBase::Update(CurrTime, ElapsedTime);
