...
// @runeb temporary until this becomes part of the spec
#define XR_UNITY_hand_model_pose 1
#define XR_UNITY_hand_model_pose_SPEC_VERSION 1
#define XR_UNITY_HAND_MODEL_POSE_EXTENSION_NAME "XR_UNITY_hand_model_pose"
